    ...
    <footer className="bg-gray-950 text-gray-400 py-6 mt-12 border-t border-gray-800">
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 px-4">
        ...
        <div className="flex gap-4 items-center">
          <a
            href="#"
            className="hover:text-blue-400 transition ml-4 px-4 py-2 border border-blue-500 rounded text-blue-400 hover:bg-blue-500 hover:text-white transition"
          >
            LinkedIn
          </a>
          <a
    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center">
      <div className="bg-gray-800 rounded-lg shadow-lg p-8 w-full max-w-3xl">
        <div className="flex items-center mb-6">
          <BotaoVoltar />
          <h1 className="text-2xl font-bold text-blue-400 text-center flex-1">
        ...
        <ul className="space-y-6 mb-6">
          ...
          {desafios.map((d) => (
            <li
              key={d.id}
              className="border border-blue-500 p-4 rounded bg-gray-900"
            >
              <div className="font-semibold text-white">{d.titulo}</div>
              <div className="text-sm text-gray-300 mb-2">{d.descricao}</div>
              <form
                onSubmit={(e) => handleSubmit(e, d.id)}
